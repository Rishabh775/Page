          ...
          <div>
            ...
            <div className="absolute right-10 top-8">
              <div className=" relative">
                <div className="bottom-0 w-full rounded-bl-3xl rounded-br-3xl py-2 absolute text-white bg-[#0000005d] backdrop-blur-sm px-6">
            ...
            <div className="absolute bottom-[14px] right-[38rem]">
              <div className=" relative">
            ...
            <div>
              <div className="absolute bottom-[14px] right-[58rem]">
                <div className=" relative">
                  <p className=" absolute text-xl ms-4 mt-2">
                    TEACHERS <br />& STAFFS
                  </p>
            ...
            <div className="absolute bottom-[14px] left-[32px]">
              <div className=" relative">
                <p className=" absolute text-xl ms-4 mt-2">
                  STUDENTS <br />& PARENTS
                </p>
